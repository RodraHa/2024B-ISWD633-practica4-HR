...
Se ejecutaron en total 8 pasos.
...
```
docker build -t ejemplo:1.1 .
```

**¿Cuántos pasos se han ejecutado? ¿Observa algo diferente en la creación de la imagen?**

En total se ejecutaron 7 pasos. Entre la salida por la terminal se observa la instrucción CACHED FROM, además de que la creación de la imagen fue mucho más rápida.
...
```
docker run -d -P --name contenedorEjemplo ejemplo:1.1 
```
...
Es una imagen sin etiquetas, generalmente resultado de procesos de construcción donde las etiquetas se reasignan. Se identifica con <none> en el campo de REPOSITORY o TAG.
